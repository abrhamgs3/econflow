...
# ---------------------------------------------------------------------------
_APP_DIR     = Path(__file__).parent           # examples/ai_productivity_paper/app/
_EXAMPLE_DIR = _APP_DIR.parent                 # examples/ai_productivity_paper/
_DEMO_CSV    = _EXAMPLE_DIR / "data" / "demo" / "panel_demo.csv"
